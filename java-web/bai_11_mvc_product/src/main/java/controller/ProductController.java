...
public class ProductController extends HttpServlet {
    ProductRepository productService = new ProductRepository();
    ...
    private void formEdit(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Product product = productService1.findById(id);
    ...
    private void editProduct(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Product productEdit = new Product(name, price, quantity, description);
    ...
    private void createProduct(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        Product product = new Product(newId, newName, newPrice, newQuantity, newDescription);
